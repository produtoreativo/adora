...
export class createLeadTimeContext1646611729065 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."events_eventtype_enum" AS ENUM('START_CYCLE', 'FINISH', 'SHIP', 'PROMOTE', 'FAIL', 'RECOVERY', 'GENERIC')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."events_eventtype_enum_old" AS ENUM('START_CYCLE', 'SHIP', 'PROMOTE', 'FAIL', 'RECOVERY', 'GENERIC')`);
        await queryRunner.query(`ALTER TABLE "events" ALTER COLUMN "eventType" DROP DEFAULT`);
