...
export class createLeadTimeContext1646611729065 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD "startedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "events" ALTER COLUMN "eventType" TYPE "events_eventtype_enum" USING "eventType"::"text"::"events_eventtype_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "events" ALTER COLUMN "eventType" SET DEFAULT 'START_CYCLE'`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "events" ALTER COLUMN "eventType" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE "events" ALTER COLUMN "eventType" TYPE "events_eventtype_enum_old" USING "eventType"::"text"::"events_eventtype_enum_old"`,
    );
    await queryRunner.query(
      `ALTER TABLE "events" ALTER COLUMN "eventType" SET DEFAULT 'START_CYCLE'`,
    );
