...
# Pegar o ID das VPC
VPC_ID=$(aws ec2 describe-vpcs --query "Vpcs[*].VpcId" --filter "Name=tag:Name,Values=adora-vpc" --output text)
echo "ID da VPC: $VPC_ID"
...
echo "Subnets da VPC($VPC_ID): [$subnet1, $subnet2]"

# não precisa
# aws ec2 modify-subnet-attribute \
#   --subnet-id $subnet1 \
#   --map-public-ip-on-launc
# aws ec2 modify-subnet-attribute \
#   --subnet-id $subnet2 \
